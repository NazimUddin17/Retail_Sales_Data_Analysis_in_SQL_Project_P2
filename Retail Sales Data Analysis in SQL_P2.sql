-- Retail Sales Data Analysis in SQL_P2
...
-- To change the data type of the two columns sale_date & sale_time from "text" to "DATE" & "TIME" 
UPDATE retail_sales
...
-- Q.2 Write a SQL query to calculate the total sales and total revenue where the category is 'Clothing' and the quantity sold is in the month of Nov-2022
